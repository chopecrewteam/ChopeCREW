...
public class PDFFont extends PDFObject implements Serializable {
	...
	public PDFFont(String name, String type, String font, int style) {
		...
		// default PDF Font name : si le nom java n'est pas dans la liste, on
		// prend arial / helvetica (cf sur Mac ArialMT)
		this.font = base14[0][1 + style];
		this.javaFont = base14[0][0];
		// this.font = font;
		// this.javaFont = "/" + font;
		
		// attempt to translate the font name from Java to PDF
		for (String[] element : base14) {
			if (element[0].equals(f)) {
				this.javaFont = element[0];
				this.font = element[1 + style];
	...
	public void write(OutputStream os) throws IOException {
		...
		if (System.getProperty("file.encoding").equals("MacRoman")) {
			os.write("/MacRomanEncoding".getBytes());
		}
		else {
	...
	protected boolean equals(String type, String font, int style) {
		return this.type.equals(type) && (this.font.equalsIgnoreCase(font) || this.javaFont.equalsIgnoreCase(font)) && (this.style == style);
	...
	// java name, NORMAL, BOLD, ITALIC, BOLD+ITALIC
	{ "arial", "/Helvetica", "/Helvetica-Bold", "/Helvetica-Oblique", "/Helvetica-BoldOblique" }, { "helvetica", "/Helvetica", "/Helvetica-Bold", "/Helvetica-Oblique", "/Helvetica-BoldOblique" }, { "sansserif", "/Helvetica", "/Helvetica-Bold", "/Helvetica-Oblique", "/Helvetica-BoldOblique" }, { "times new roman", "/Times-Roman", "/Times-Bold", "/Times-Italic", "/Times-BoldItalic" }, { "serif", "/Times-Roman", "/Times-Bold", "/Times-Italic", "/Times-BoldItalic" }, { "courier", "/Courier", "/Courier-Bold", "/Courier-Oblique", "/Courier-BoldOblique" }, { "monospaced", "/Courier", "/Courier-Bold", "/Courier-Oblique", "/Courier-BoldOblique" }, { "dialog", "/Courier", "/Courier-Bold", "/Courier-Oblique", "/Courier-BoldOblique" }, { "dialoginput", "/Courier", "/Courier-Bold", "/Courier-Oblique", "/Courier-BoldOblique" }, };
