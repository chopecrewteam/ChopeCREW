 ...
 * the PDF document's internal structures are kept in sync.
 * </p>
 * 
 * <p>
...
public class PDFDocument implements Serializable {
	 ...
	 * page visible. This is the default
	 * </p>
	 */
	 ...
	 * 
	 * @param pagemode
	 *            an int, determines how the document will present itself to the
	 *            viewer when it first opens.
	 */
